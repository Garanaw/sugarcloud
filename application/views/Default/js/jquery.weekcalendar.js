	...
	$.widget('ui.weekCalendar', (function() {
		...
		return {
			options: {
				...
				/**
					* EDITED BY PABLO VILLALBA
					*/
				/**
				 * Params for the rendered calendar
				 */
				buttonsDefaultClasses: '',

				buttonsClasses: '',

				buttonsPrevDefaultClasses: '',

				buttonsPrevClasses: '',

				buttonsTodayDefaultClasses: '',

				buttonsTodayClasses: '',

				buttonsNextDefaultClasses: '',

				buttonsNextClasses: '',

				wrapperDefaultClasses: 'ui-widget wc-container',
			...
			_create: function() {
				var self = this;
				//alert(self.options.wrapperClasses);
			...
			_renderCalendar: function() {
				...
				var calClasses = this.options.wrapperDefaultClasses;
				//alert(this.options.wrapperClasses);
				if(!!this.options.wrapperClasses){
					calClasses += ' '+this.options.wrapperClasses;
				}
				//alert(calClasses);

				// container -> wrapperClasses
				//$calendarContainer = $('<div class=\"ui-widget wc-container\">').appendTo(self.element);
				$calendarContainer = $('<div class=\"'+calClasses+'\">').appendTo(self.element);
