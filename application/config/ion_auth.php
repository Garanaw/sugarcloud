...
*/
$config['tables']['users']           = 'wi_users';
$config['tables']['groups']          = 'wi_groups';
$config['tables']['users_groups']    = 'wi_users_groups';
$config['tables']['login_attempts']  = 'wi_login_attempts';
$config['tables']['users_meta']		 = 'wi_users_meta';
$config['tables']['user_meds']		 = 'wi_users_meds';
 ...
 */
$config['site_title']                 = "Sugar.com";       // Site Title, example.com
$config['admin_email']                = "garanaw@gmail.com"; // Admin Email, admin@example.com
